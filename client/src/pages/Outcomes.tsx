        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: <Clock className="w-7 h-7 text-teal" />, title: "Reduced Vacancy Downtime", desc: "Minimise the time between participants with priority replacement search and proactive vacancy management included in the Vacancy Protection Plan.", variant: "bottom" as const },
