      ...
      <section className="bg-navy text-white py-16 lg:py-24">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-gray-400 text-sm mt-3">
            Ausnew Holdings Pty Ltd (ACN 668 431 338) trading as APGP | apgpaccommodation.com.au
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="container max-w-4xl">
              ...
              <Sub title="2.1 Definitions">
                <div className="overflow-x-auto rounded-xl border border-gray-200">
                  <table className="w-full text-xs">
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ["APGP", "Ausnew Holdings Pty Ltd (ACN 668 431 338) trading as Accommodation Provider Growth Program, being an independent referral and marketing platform for NDIS accommodation providers."],
          ...
          <p className="text-xs text-gray-400 text-center mt-6">
            © 2026 Ausnew Holdings Pty Ltd (ACN 668 431 338) trading as Accommodation Provider Growth Program (APGP). All rights reserved.
          </p>
        </div>
      </section>
